...
export default function Page(){
  ...
  return(<div className="space-y-6"><h1 className="text-2xl font-semibold">Interests</h1><SimpleAnswerForm returnId={returnId} keyPath="income.capital.interests" fields={[{name:"amount",label:"Total interests",type:"number"}]} /><SuggestionsPanel returnId={returnId} section="capital"/><BranchNavControls clientId={clientId} returnId={returnId}/></div>)}
