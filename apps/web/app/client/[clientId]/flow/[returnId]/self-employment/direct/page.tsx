...
export default function Page(){
  ...
  return(<div className="space-y-6"><h1 className="text-2xl font-semibold">Economic activities — Direct estimation</h1><SimpleAnswerForm returnId={returnId} keyPath="income.selfemployment.direct" fields={[{name:"ingresos",label:"Ingresos",type:"number"},{name:"gastos",label:"Gastos",type:"number"}]} /><BranchNavControls clientId={clientId} returnId={returnId}/></div>)}
